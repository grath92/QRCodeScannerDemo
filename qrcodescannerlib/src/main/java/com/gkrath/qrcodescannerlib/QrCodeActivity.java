package com.gkrath.qrcodescannerlib;
...
import com.gkrath.qrcodescannerlib.camera.CameraManager;
import com.gkrath.qrcodescannerlib.decode.CaptureActivityHandler;
import com.gkrath.qrcodescannerlib.decode.DecodeImageCallback;
import com.gkrath.qrcodescannerlib.decode.DecodeImageThread;
import com.gkrath.qrcodescannerlib.decode.DecodeManager;
import com.gkrath.qrcodescannerlib.decode.InactivityTimer;
import com.gkrath.qrcodescannerlib.view.QrCodeFinderView;
...
public class QrCodeActivity extends Activity implements Callback, OnClickListener {
    ...
    private String[] appPermissions = {Manifest.permission.CAMERA, Manifest.permission.VIBRATE};
    ...
    private void requestPermission() {
        List<String> lstPer = new ArrayList<>();
        lstPer.add(appPermissions[0]);
        lstPer.add(appPermissions[1]);
        ActivityCompat.requestPermissions(this, lstPer.toArray(new String[lstPer.size()]), 101);
        mPermissionOk = true;
        //ActivityCompat.requestPermissions(this, appPermissions,0);
    }
